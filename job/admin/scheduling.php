                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
							...
							<li class="active">
                                <a href="applicant.php"><i class="ti-dashboard"></i><span>Scheduling</span></a>
                            </li>
                            <li>
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$job=mysqli_query($conn,"SELECT applicant_name, alamat, tanggal, pic, telp from applicant a, applicant_scheduling s where a.applicant_id=s.applicant_id and tanggal >= '$date_now'");
											$no=1;
											while($p=mysqli_fetch_array($job)){
												...
												<tr>
													<td><?php echo $no++ ?></td>
													<td><?php echo $p['applicant_name'] ?></td>
